...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, scale=False, **kwargs):
...
def ResNet18(scale):
    print(f'initializing resnet18 with scale flag: {scale}')
    return ResNet(BasicBlock, [2, 2, 2, 2], scale=scale)
